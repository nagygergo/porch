...
//go:generate go run sigs.k8s.io/controller-tools/cmd/controller-gen@v0.14.0 rbac:roleName=porch-controllers,headerFile="../scripts/boilerplate.yaml.txt" webhook paths="."

//go:generate go run sigs.k8s.io/controller-tools/cmd/controller-gen@v0.14.0 paths="./..." crd:headerFile="../scripts/boilerplate.yaml.txt" output:crd:artifacts:config=config/crd/bases
