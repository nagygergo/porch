...
//go:generate go run sigs.k8s.io/controller-tools/cmd/controller-gen@v0.14.0 rbac:roleName=porch-controllers-packagevariants,headerFile="../../../../../scripts/boilerplate.yaml.txt" webhook paths="." output:rbac:artifacts:config=../../../config/rbac
